object frmMaquinasCustomColEdit: TfrmMaquinasCustomColEdit
  Left = 0
  Top = 0
  ...
  object lblHelp: TLabel
    ...
    AutoSize = False
    Caption =
      'ColumnKey solo letras/numeros/guion-bajo. Ejemplo: VOLTAJE, ES_E' +
      'XTERNA. No se puede cambiar despues de crearla.'
    WordWrap = True
  end
