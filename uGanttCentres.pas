...
begin
  FCentres := Copy(ACentres);   // o sense Copy si vols refer�ncia directa
  Invalidate;
end;
...
var
  ...
  midY: Single;
begin
  // devuelve el �ndice donde insertar (0..Length(FRows))
  yWorld := Y + FScrollY;
...
begin
  ...
  // si insertas �despu�s� y quitas antes, el destino se desplaza
  dst := ToIndex;
...
begin
  ...
  begin
    // L'últim row visible determina el ContentHeight
...
begin
  ...
  // Si estamos armados para drag y movemos m�s que el umbral -> empezamos a arrastrar
