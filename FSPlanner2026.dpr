...
uses
  ...
  uGanttControlTareas in 'uGanttControlTareas.pas',
  uGanttControlMaquinas in 'uGanttControlMaquinas.pas',
  uWbsSobrecarga in 'uWbsSobrecarga.pas',
  uModulos in 'uModulos.pas',
  uModulosConfig in 'uModulosConfig.pas' {frmModulosConfig},
  uDemoPerfiles in 'uDemoPerfiles.pas',
  uDemoPerfilGen in 'uDemoPerfilGen.pas',
  uDemoPerfilDlg in 'uDemoPerfilDlg.pas' {frmDemoPerfilDlg},
  uWbsResumen in 'uWbsResumen.pas',
  uWbsPanelEsfuerzo in 'uWbsPanelEsfuerzo.pas' {frmWbsPanelEsfuerzo},
  uWbsNivelacion in 'uWbsNivelacion.pas',
  uWbsNivelacionDlg in 'uWbsNivelacionDlg.pas' {frmWbsNivelacionDlg},
  ...
  uHeatmapCargaOperario in 'uHeatmapCargaOperario.pas' {frmHeatmapCargaOperario},
  uHeatmapEntregasVsCarga in 'uHeatmapEntregasVsCarga.pas' {frmHeatmapEntregasVsCarga},
  uHistogramasOperarios in 'uHistogramasOperarios.pas' {frmHistogramasOperarios},
  ...
  uUserPreferencesRepo in 'uUserPreferencesRepo.pas',
