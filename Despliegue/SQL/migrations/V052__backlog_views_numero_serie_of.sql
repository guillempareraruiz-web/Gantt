-- ===========================================================================
-- V052 - FS_PL_vw_Backlog / FS_PL_vw_BacklogPlanned: exponer NumeroOF y SerieOF
--        como columnas propias (siempre de la OF raiz), para el grid del Backlog.
--
-- Motivo: NumeroDoc/SerieDoc heredados son ambiguos en OP/OT (NumeroDoc=0 en
-- niveles inferiores y COALESCE no salta el 0). Igual que CodigoOT/CodigoOP,
-- exponemos el numero y la serie de la OF raiz de forma explicita segun el nivel:
--   Nivel 1 (OF) -> propios (ri)
--   Nivel 2 (OT) -> del padre  (p1 = OF)
--   Nivel 3 (OP) -> del abuelo (p2 = OF)
-- Solo para familia OF; para PED/PRJ quedan NULL.
--
-- Reescribe ambas vistas a partir de V051 (mismo contenido + 2 columnas).
-- ===========================================================================
...
SELECT
    ...
    -- Numero y serie de la OF raiz (solo familia OF), explicitos por nivel.
