object frmOperariosCustomColEdit: TfrmOperariosCustomColEdit
  Left = 0
  Top = 0
  ...
  object lblHelp: TLabel
    ...
    AutoSize = False
    Caption =
      'ColumnKey solo letras/numeros/guion-bajo. Ejemplo: DNI, TELEFONO' +
      '. No se puede cambiar despues de crearla.'
    WordWrap = True
  end
